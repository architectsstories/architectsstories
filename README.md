...
The official supplied Architects Stories logo remains unchanged as `as-logo.png`.

Images are loaded from Unsplash URLs, so internet access is required when previewing the site.
